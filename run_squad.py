...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.model_type in ["xlm", "roberta", "distilbert", "camembert", "bart", "longformer", "mbart"]:
    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating", position=0, leave=True):
        ...
        for i, feature_index in enumerate(feature_indices):
            ...
            if args.model_type == "mbart":
                output = [to_list(output[i]) for output in outputs.to_tuple()[:2]]
            else:
...
def main():
    ...
    parser.add_argument("--warmup_proportion", default=0.1, type=float, help="Linear warmup over warmup steps based on warmup proportion.")
    parser.add_argument(
        "--n_best_size",
        default=20,
        type=int,
